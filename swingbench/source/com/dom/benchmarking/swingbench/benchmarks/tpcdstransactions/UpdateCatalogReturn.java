...
public class UpdateCatalogReturn extends DatabaseTransaction {
    public UpdateCatalogReturn() {
    }
    ...
    public void execute(Map params) throws SwingBenchException {
        ...
        try {
            try {
                CallableStatement cs = connection.prepareCall("{? = call pkg_tpcds_transactions.UpdateCatalogReturn(?,?)}");
