...
public class UpdateStoreSales extends DatabaseTransaction {
    public UpdateStoreSales() {
    }
    ...
    public void execute(Map params) throws SwingBenchException {
        ...
        try {
            try {
                CallableStatement cs = connection.prepareCall("{? = call pkg_tpcds_transactions.UpdateStoreSales(?,?)}");
