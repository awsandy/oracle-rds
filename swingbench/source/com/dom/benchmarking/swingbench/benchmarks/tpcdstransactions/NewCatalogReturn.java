...
public class NewCatalogReturn extends DatabaseTransaction {
    public NewCatalogReturn() {
    }
    ...
    public void execute(Map params) throws SwingBenchException {
        ...
        try {
            try {
                CallableStatement cs = connection.prepareCall("{? = call pkg_tpcds_transactions.NewCatalogReturn(?,?)}");
