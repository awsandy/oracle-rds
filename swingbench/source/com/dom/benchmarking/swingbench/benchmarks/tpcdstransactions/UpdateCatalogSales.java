...
public class UpdateCatalogSales extends DatabaseTransaction {
    public UpdateCatalogSales() {
    }
    ...
    public void execute(Map params) throws SwingBenchException {
        ...
        try {
            try {
                CallableStatement cs = connection.prepareCall("{? = call pkg_tpcds_transactions.UpdateCatalogSales(?,?)}");
