...
public class NewStoreReturn extends DatabaseTransaction {
    public NewStoreReturn() {
    }
    ...
    public void execute(Map params) throws SwingBenchException {
        ...
        try {
            try {
                CallableStatement cs = connection.prepareCall("{? = call pkg_tpcds_transactions.NewStoreReturn(?,?)}");
