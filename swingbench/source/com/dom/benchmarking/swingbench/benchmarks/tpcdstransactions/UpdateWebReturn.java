...
public class UpdateWebReturn extends DatabaseTransaction {
    public UpdateWebReturn() {
    }
    ...
    public void execute(Map params) throws SwingBenchException {
        ...
        try {
            try {
                CallableStatement cs = connection.prepareCall("{? = call pkg_tpcds_transactions.UpdateWebReturn(?,?)}");
