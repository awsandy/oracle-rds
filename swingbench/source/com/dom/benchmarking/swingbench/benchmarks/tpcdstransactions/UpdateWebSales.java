...
public class UpdateWebSales extends DatabaseTransaction {
    public UpdateWebSales() {
    }
    ...
    public void execute(Map params) throws SwingBenchException {
        ...
        try {
            try {
                CallableStatement cs = connection.prepareCall("{? = call pkg_tpcds_transactions.UpdateWebSales(?,?)}");
