...
public class UpdateStoreReturn extends DatabaseTransaction {
    public UpdateStoreReturn() {
    }
    ...
    public void execute(Map params) throws SwingBenchException {
        ...
        try {
            try {
                CallableStatement cs = connection.prepareCall("{? = call pkg_tpcds_transactions.UpdateStoreReturn(?,?)}");
