...
public class NewCatalogSales extends DatabaseTransaction {
    public NewCatalogSales() {
    }
    ...
    public void execute(Map params) throws SwingBenchException {
        ...
        try {
            try {
                CallableStatement cs = connection.prepareCall("{? = call pkg_tpcds_transactions.newcatalogsales(?,?)}");
